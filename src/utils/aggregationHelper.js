 ...
 *
 * @function
 * @param {string[]} fieldsArray - The array of strings - database fields where search should be performed.
 * @param {string} searchValue - One or more words to look for.
 *
 * @returns {object} The MongoDB aggregate pipeline part that matches coincidences.
 *
 */
